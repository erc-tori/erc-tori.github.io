...
target='new'>
        ...
        <br>
        <a target='new' href="https://youtu.be/2e9cPrvrKlo?si=8MfL1hEvOcfDUXvN">Video</a>
        -
...
href="https://arxiv.org/abs/2303.15491"
        ...
        Accepted, to be presented at IEEE VIS 2023.<br>
        <br>
        <a target="new" href="https://github.com/rgcmaack/PLMSS-Replicability-Stamp">
        Code</a>
        -
...
target='new'
          ...
          'stuff/doraiswamy_vis20.pdf_mini']);"
        >
          <img src='https://julien-tierny.github.io/img/doraiswamy_vis20_mini.png' width="100%"/></a>
        </td>
        <td width="5%" />
        <td width="100%">
                <a target='new' 
...
target='new'
          ...
          'stuff/lukasczyk_vis20.pdf_mini']);"
        >
          <img src='https://julien-tierny.github.io/img/lukasczyk_vis20_mini.png' width="100%"/></a>
        </td>
        <td width="2%" />
        <td width="77%">
                <a target='new' 
href="https://arxiv.org/abs/2009.00083"
        ...
        Proc. of IEEE VIS 2020.<br>
        <br>
        <a target="new" href="https://github.com/JonasLukasczyk/lts-sample-code"
         onClick="javascript:_gaq.push(['_trackPageview',
              'stuff/software/lukasczyk_vis20_code']);"
        >Code</a> 
        </td>
      </tr>
...
<tr>
        <td width='25%'>
        <a 
href="https://topology-tool-kit.github.io/stuff/ttk_tutorial_vis20.pdf" 
target='new'
          onClick="javascript:_gaq.push(['_trackPageview',
          'stuff/ttk_tutorial_vis20.pdf']);_gaq.push(['_trackPageview',
          'stuff/ttk_tutorial_vis20.pdf_mini']);"
        >
          <img src='https://julien-tierny.github.io/img/falk_visTutorial20_mini.png' width="100%"/></a>
        </td>
        <td width="2%" />
        <td width="77%">
                <a target='new' 
href="https://topology-tool-kit.github.io/stuff/ttk_tutorial_vis20.pdf"
        ...
        <br><br>
        IEEE VIS Tutorials 2020.<br>
        <br>
         <a target='new' 
            
href="https://topology-tool-kit.github.io/ieeeVisTutorial.html"
                onClick="javascript:_gaq.push(['_trackPageview',
              'stuff/ttk_tutorial_vis20_web']);"
        >Tutorial web page</a>
        </td>
      </tr>
    ...
    <tr>
        <td width='25%'>
        <a 
href="https://julien-tierny.github.io/stuff/papers/cotsakis_topoinvis20.pdf" 
target='new'
          onClick="javascript:_gaq.push(['_trackPageview',
          'stuff/cotsakis_topoinvis20.pdf']);_gaq.push(['_trackPageview',
          'stuff/cotsakis_topoinvis20.pdf_mini']);"
        >
          <img src='https://julien-tierny.github.io/img/cotsakis_topoinvis20_mini.png' width="100%"/></a>
        </td>
        <td width="2%" />
        <td width="77%">
                <a target='new' 
href="https://julien-tierny.github.io/stuff/papers/cotsakis_topoinvis20.pdf"
                onClick="javascript:_gaq.push(['_trackPageview',
              'stuff/cotsakis_topoinvis20.pdf']);_gaq.push(['_trackPageview',
              'stuff/cotsakis_topoinvis20.pdf']);"
                >
        ...
        <br><br>
        Upcoming TopoInVis book (accepted).<br>
        <br>
        </td>
      </tr>
...
<tr height="75pt"/>
    ...
    <tr>
        <td width='25%'>
        <a 
href="https://julien-tierny.github.io/stuff/papers/lukasczyk_topoInVis19.pdf" 
target='new'
          onClick="javascript:_gaq.push(['_trackPageview',
          'stuff/lukasczyk_topoInVis19.pdf']);_gaq.push(['_trackPageview',
          'stuff/lukasczyk_topoInVis19.pdf_mini']);"
        >
          <img src='https://julien-tierny.github.io/img/lukasczyk_topoInVis19_mini.png' width="100%"/></a>
        </td>
        <td width="2%" />
        <td width="77%">
                <a target='new' 
href="https://julien-tierny.github.io/stuff/papers/lukasczyk_topoInVis19.pdf"
                onClick="javascript:_gaq.push(['_trackPageview',
              'stuff/lukasczyk_topoInVis19.pdf']);_gaq.push(['_trackPageview',
              'stuff/lukasczyk_topoInVis19.pdf']);"
                >
